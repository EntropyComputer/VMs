...
bool vm_spinUpGoldenImage() {
  ...
  std::string diskPath = "/var/lib/libvirt/images/goldenImage.qcow2";
  ...
  std::string createImageCmd = "qemu-img create -f qcow2 " + diskPath + " " + std::to_string(storageGB) + "G";
  ...
  std::string(R"XML(<domain type='kvm'>
    ...
    <devices>
      <disk type='file' device='cdrom'>
        ...
        <source file=")XML") + windowsIsoPath + std::string(R"XML("/>
